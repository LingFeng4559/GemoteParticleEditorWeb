...
class CodeGenerator {
    ...
    generate() {
        ...
        lines.push(`  #@gemote-bake ${JSON.stringify({ frameInterval: baked.frameInterval, frameCount: baked.frameCount, step: baked.bakeStep, particleStride: baked.particleStride, idealCommands: baked.idealCommands, commands: baked.estimatedCommands, limit: Number.isFinite(limit) ? limit : 'all' })}`);
        let lastTick = 0;
    ...
    getCommandLimit() {
        ...
        if (selected === 'all') return Infinity;
